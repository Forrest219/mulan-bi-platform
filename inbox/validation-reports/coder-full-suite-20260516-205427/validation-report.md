...
- exit_code: `0`
- log: `inbox/validation-reports/coder-full-suite-20260516-205427/task1-data-agent-e2e.log`

### TASK 2 - Full backend suite: FAIL

- cwd: `/Users/forrest/Projects/mulan-bi-platform/backend`
- command: `/Users/forrest/Projects/mulan-bi-platform/backend/.venv/bin/python -m pytest tests/ -x -q`
- exit_code: `1`
- log: `inbox/validation-reports/coder-full-suite-20260516-205427/task2-full-backend-suite.log`
...
- exit_code: `0`
- log: `inbox/validation-reports/coder-full-suite-20260516-205427/task3-p1-quality-governance.log`
