...
| Visualization Agent 补充Spec | docs/specs/26-visualization-agent-addendum.md | 报告中的图表 spec 由 Visualization Agent 生成 |
...
┌─────────────────────────────────────────────┐
│          下游 Agent / 服务                    │
│  SQL Agent（HTTP API）│ Visualization Agent │
...
| Visualization Agent | HTTP API (`/api/agents/visualization/spec`) | 生成图表配置 |
