...
export function HealthTab({ healthData, healthLoading, healthError, onLoad }: HealthTabProps) {
  return (
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-5">
        ...
        {healthLoading ? (
          ...
          <div className="text-center py-10">
            ...
            <button onClick={onLoad} className="px-5 py-2.5 text-sm bg-slate-900 text-white rounded-lg hover:bg-slate-800">
