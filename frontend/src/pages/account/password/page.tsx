...
export default function AccountPasswordPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-8 px-4">
      <h1 className="text-lg font-semibold text-slate-900 mb-1">修改密码</h1>
      <p className="text-sm text-slate-500 mb-6">更新你的登录密码</p>
      ...
      {toastMsg && (
        <div className="fixed bottom-6 right-6 text-white text-sm px-4 py-2.5 rounded-lg z-50 flex items-center gap-2 shadow-lg bg-slate-800">
